...
namespace Ra
{
    namespace Engine
    {
        ...
        PhotoStudioRenderer::PhotoStudioRenderer( uint width, uint height )
                : Renderer(width, height)
        {
        }

        PhotoStudioRenderer::~PhotoStudioRenderer()
        {
            ShaderProgramManager::destroyInstance();
        }

        void PhotoStudioRenderer::initializeInternal()
        {
            initShaders();
            initBuffers();
            initLights();
        ...
        void PhotoStudioRenderer::initBuffers()
        {
        ...
        void PhotoStudioRenderer::debugInternal( const RenderData& renderData )
        {
            if ( m_drawDebug )
            {
                const ShaderProgram* shader;
...
//#ifndef NO_TRANSPARENCY
        ...
        void PhotoStudioRenderer::uiInternal( const RenderData& renderData )
        {
            const ShaderProgram* shader;
        ...
        void PhotoStudioRenderer::postProcessInternal( const RenderData& renderData )
        {
        ...
        void PhotoStudioRenderer::resizeInternal()
        {
